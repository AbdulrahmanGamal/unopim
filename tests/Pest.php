...
use Webkul\Pricing\Tests\PricingTestCase;
...
uses(ChannelConnectorTestCase::class)->in('Feature/ChannelConnector');
uses(PricingTestCase::class)->in('../packages/Webkul/Pricing/tests');
uses(OrderTestCase::class)->in('../packages/Webkul/Order/tests');
