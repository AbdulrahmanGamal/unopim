...
Route::group(['middleware' => ['web', 'admin', 'tenant'], 'prefix' => config('app.admin_url')], function () {
    Route::prefix('magento2')->group(function () {
        ...
        Route::controller(CredentialController::class)->prefix('credentials')->group(function () {
            Route::get('', 'index')->name('admin.magento2.credentials.index');
            Route::post('create', 'store')->name('admin.magento2.credentials.store');
            Route::get('edit/{id}', 'edit')->name('admin.magento2.credentials.edit');
            Route::put('update/{id}', 'update')->name('admin.magento2.credentials.update');
            Route::delete('delete/{id}', 'destroy')->name('admin.magento2.credentials.delete');
        });

        Route::prefix('export')->group(function () {
            Route::controller(SettingController::class)->prefix('settings')->group(function () {
                Route::get('{id}', 'index')->name('admin.magento2.settings');
                Route::post('create', 'store')->name('admin.magento2.export-settings.create');
            });
            Route::controller(MappingController::class)->prefix('mapping')->group(function () {
                ...
                Route::post('create', 'store')->name('admin.magento2.export-mappings.create');
            });
        });
        ...
        Route::prefix('import')->group(function () {
            Route::controller(ImportMappingController::class)->prefix('mapping')->group(function () {
                ...
                Route::post('create', 'store')->name('admin.magento2.import-mappings.create');
            });
        });
        ...
        Route::controller(OptionController::class)->group(function () {
            ...
            Route::get('get-magento2-credentials', 'listMagento2Credential')->name('admin.magento2.credential.fetch-all');
            Route::get('get-magento2-channel', 'listChannel')->name('admin.magento2.channel.fetch-all');
            Route::get('get-magento2-currency', 'listCurrency')->name('admin.magento2.currency.fetch-all');
            Route::get('get-magento2-locale', 'listLocale')->name('admin.magento2.locale.fetch-all');
            Route::get('get-magento2-attrGroup', 'listAttributeGroup')->name('admin.magento2.attribute-group.fetch-all');
