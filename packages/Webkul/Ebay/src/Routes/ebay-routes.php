...
Route::group(['middleware' => ['web', 'admin', 'tenant'], 'prefix' => config('app.admin_url')], function () {
    Route::prefix('ebay')->group(function () {
        ...
        Route::controller(CredentialController::class)->prefix('credentials')->group(function () {
            Route::get('', 'index')->name('admin.ebay.credentials.index');
            Route::post('create', 'store')->name('admin.ebay.credentials.store');
            Route::get('edit/{id}', 'edit')->name('admin.ebay.credentials.edit');
            Route::put('update/{id}', 'update')->name('admin.ebay.credentials.update');
            Route::delete('delete/{id}', 'destroy')->name('admin.ebay.credentials.delete');
        });

        Route::prefix('export')->group(function () {
            Route::controller(SettingController::class)->prefix('settings')->group(function () {
                Route::get('{id}', 'index')->name('admin.ebay.settings');
                Route::post('create', 'store')->name('admin.ebay.export-settings.create');
            });
            Route::controller(MappingController::class)->prefix('mapping')->group(function () {
                Route::get('{id}', 'index')->name('admin.ebay.export-mappings');
                Route::post('create', 'store')->name('admin.ebay.export-mappings.create');
            });
        });
        ...
        Route::prefix('import')->group(function () {
            Route::controller(ImportMappingController::class)->prefix('mapping')->group(function () {
                ...
                Route::post('create', 'store')->name('admin.ebay.import-mappings.create');
            });
        });
        ...
        Route::controller(OptionController::class)->group(function () {
            ...
            Route::get('get-ebay-credentials', 'listEbayCredential')->name('admin.ebay.credential.fetch-all');
            Route::get('get-ebay-channel', 'listChannel')->name('admin.ebay.channel.fetch-all');
            Route::get('get-ebay-currency', 'listCurrency')->name('admin.ebay.currency.fetch-all');
            Route::get('get-ebay-locale', 'listLocale')->name('admin.ebay.locale.fetch-all');
            Route::get('get-ebay-attrGroup', 'listAttributeGroup')->name('admin.ebay.attribute-group.fetch-all');
