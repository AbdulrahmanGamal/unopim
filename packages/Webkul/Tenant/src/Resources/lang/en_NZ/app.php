...
return [
    'tenants' => [
        ...
        'switch-forbidden' => 'Only platform operators can switch tenant context.',
        'switch-not-found' => 'Tenant not found or not active.',
        'switch-cleared'   => 'Switched to Platform view (all tenants).',
        'switch-success'   => 'Switched to tenant: :name',
    ],
